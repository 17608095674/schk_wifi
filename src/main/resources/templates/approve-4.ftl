            ...
            <div>
                ...
                <div class="div1" style="display: none;" id="div1">
                    <table>
                        <tr>
                            <td><span class="sp1">处理人</span></td>
                            <td><span class="sp2" id="apn3"></span></td>
                        </tr>
                        <tr>
                            <td><span class="sp1">处理意见</span></td>
                            <td><span class="sp2" id="opinion3"></span></td>
                        </tr>
                        <tr>
                            <td><span class="sp1">处理时间</span></td>
                            <td><span class="sp2" id="date3"></span></td>
                        </tr>
                    </table>
                </div>
...
<script type="text/javascript">
    ...
    function loadInit1() {
        ...
        $("#date2").html(GetQueryString("date2"));
        //
    }
    ...
    $("#passbtn").click(function () {
        $("#apn3").html(GetQueryString("apn3"));
        $("#date3").html(new Date().Format('yyyy-MM-dd hh:mm:ss'));
        $("#div2").hide();
        $("#idea").hide();
        $("#btn").hide();
        $("#div1").show();
