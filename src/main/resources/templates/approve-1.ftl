            ...
            <div>
                <table class="am-table">
                    <tr>
                        ...
                        <td><span class="sp2">无线互联网</span></td>
                    </tr>
                    <tr>
                ...
                <div class="div1" style="display: none" id="div1">
                    <table>
                        <tr>
                            ...
                            <td><span class="sp2" id="apn"></span></td>
                        </tr>
                        <tr>
                            <td><span class="sp1">处理意见</span></td>
                            <td><span class="sp2" id="opinion"></span></td>
                        </tr>
                        <tr>
...
<script type="text/javascript">
    ...
    /*  window.onbeforeunload = function() {
         ...
         window.opener.location.reload("http://172.18.8.92/mybox/fleshopener.htm");
